...
final RegisteredComponent containerComponentDefinition = RegisteredComponent(
  ...
  builder: (WidgetNode node, WidgetRef ref, Widget Function(WidgetNode childNode) renderChild) {
    ...
    final AlignmentGeometry alignment = ComponentUtil.parseAlignment(props['alignment']?.toString());
    ...
    if (gradientType == 'linear') {
      ...
      final Color color1 = ComponentUtil.parseColor(color1String, defaultColor: Colors.transparent);
      final Color color2 = ComponentUtil.parseColor(color2String, defaultColor: Colors.transparent);
