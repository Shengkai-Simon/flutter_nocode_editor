...
class ChildAlignmentProps {
  static List<PropField> get fields => [
    PropField(
      ...
      defaultValue: 'center', // A common general default
      options: [
...
class FlexChildProps {
  static List<PropField> get fields => [
    PropField(name: 'flex', label: 'Flex Factor', fieldType: FieldType.number, defaultValue: 1),
    PropField(name: 'fit', label: 'Fit', fieldType: FieldType.select, defaultValue: 'loose', options: [{'id': 'loose', 'name': 'Loose'}, {'id': 'tight', 'name': 'Tight'}]),
  ];
  static Map<String, dynamic> get defaults => {
    'flex': 1,
    // 'fit': 'loose',
...
class MainAxisAlignmentProp {
  static List<PropField> get fields => [
    PropField(
      ...
      defaultValue: 'start',
      options: [
        {'id': 'start', 'name': 'Start'}, {'id': 'end', 'name': 'End'}, {'id': 'center', 'name': 'Center'},
        {'id': 'spaceBetween', 'name': 'Space Between'}, {'id': 'spaceAround', 'name': 'Space Around'}, {'id': 'spaceEvenly', 'name': 'Space Evenly'},
      ],
    ),
  ];
  static Map<String, dynamic> get defaults => {
...
class CrossAxisAlignmentProp {
  static List<PropField> get fields => [
    PropField(
      ...
      options: [
        {'id': 'start', 'name': 'Start'}, {'id': 'end', 'name': 'End'}, {'id': 'center', 'name': 'Center'},
        {'id': 'stretch', 'name': 'Stretch'}, {'id': 'baseline', 'name': 'Baseline (req. textBaseline)'},
      ],
    ),
  ];
  static Map<String, dynamic> get defaults => {
...
class MainAxisSizeProp {
  static List<PropField> get fields => [
    PropField(
      ...
      fieldType: FieldType.select,
      defaultValue: 'max',
      options: [ {'id': 'min', 'name': 'Min'}, {'id': 'max', 'name': 'Max'}, ],
    ),
  ];
  static Map<String, dynamic> get defaults => {
    'mainAxisSize': 'max',
...
class BasicTextStyleProps {
  static List<PropField> get fields => [
    ...
    PropField(name: 'textColor', label: 'Text Color', fieldType: FieldType.color, defaultValue: '#000000'), // Using 'textColor' to avoid clash with 'backgroundColor'
    PropField(
      name: 'fontWeight', label: 'Font Weight', fieldType: FieldType.select, defaultValue: 'normal',
      options: [
        {'id': 'normal', 'name': 'Normal (w400)'}, {'id': 'bold', 'name': 'Bold (w700)'},
        {'id': 'w100', 'name': 'Thin (w100)'}, {'id': 'w200', 'name': 'Extra-Light (w200)'},
        {'id': 'w300', 'name': 'Light (w300)'}, {'id': 'w500', 'name': 'Medium (w500)'},
        {'id': 'w600', 'name': 'Semi-Bold (w600)'},{'id': 'w800', 'name': 'Extra-Bold (w800)'},
        {'id': 'w900', 'name': 'Black (w900)'},
      ],
    ),
    PropField(
      name: 'fontStyle', label: 'Font Style', fieldType: FieldType.select, defaultValue: 'normal',
      options: [ {'id': 'normal', 'name': 'Normal'}, {'id': 'italic', 'name': 'Italic'},],
    ),
    PropField(
      name: 'textAlign', label: 'Text Align', fieldType: FieldType.select, defaultValue: 'start',
      options: [
        {'id': 'left', 'name': 'Left'}, {'id': 'right', 'name': 'Right'}, {'id': 'center', 'name': 'Center'},
        {'id': 'justify', 'name': 'Justify'}, {'id': 'start', 'name': 'Start (Locale Specific)'}, {'id': 'end', 'name': 'End (Locale Specific)'},
      ],
    ),
  ];
  static Map<String, dynamic> get defaults => {
