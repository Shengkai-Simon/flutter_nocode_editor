...
final RegisteredComponent containerComponentDefinition = RegisteredComponent(
    ...
    defaultProps: {
      ...
      'alignment': 'center', // Default to center for better placeholder text visibility
    ...
    builder: (WidgetNode node, WidgetRef ref, Widget Function(WidgetNode childNode) renderChild) {
      ...
      // **FIX**: Add minimum constraints only when the container is empty AND has no explicit size.
      ...
      return Container(
        width: width,
        height: height,
        constraints: constraints, // Apply the minimum constraints
